...
execute if score @e[tag=dummy,limit=1] plainsAnimation matches 1 run place template m:mapswitch/plains_1 3 112 -117
...
execute if score @e[tag=dummy,limit=1] plainsAnimation matches 6 run place template m:mapswitch/plains_2 3 112 -117
...
execute if score @e[tag=dummy,limit=1] plainsAnimation matches 11 run place template m:mapswitch/plains_3 3 112 -117
