...
execute if score @e[tag=dummy,limit=1] winterAnimation matches 1 run place template m:mapswitch/winter_1 3 112 -117
...
execute if score @e[tag=dummy,limit=1] winterAnimation matches 6 run place template m:mapswitch/winter_2 3 112 -117
...
execute if score @e[tag=dummy,limit=1] winterAnimation matches 11 run place template m:mapswitch/winter_3 3 112 -117
