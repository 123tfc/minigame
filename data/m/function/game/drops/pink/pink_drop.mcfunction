execute store result score random_pink_item drop_item run random value 1..9
...
execute at @s if score random_pink_item drop_item matches 8..9 run summon item ~ ~-1 ~ {Tags:[pink_drop_item],NoGravity:1b,Item:{id:"piston",components:{"custom_name":{"text":"Extended Arms","color":"#ff9d5c","italic":false},"max_stack_size":1}},CustomName:{"text":"Extended Arms","color":"#ff9d5c","italic":false},CustomNameVisible:1b}
