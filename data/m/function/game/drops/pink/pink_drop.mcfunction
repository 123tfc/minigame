execute store result score random_pink_item drop_item run random value 1..11
...
execute at @s if score random_pink_item drop_item matches 8..9 run summon item ~ ~-1 ~ {Tags:[pink_drop_item],NoGravity:1b,Item:{id:"piston",components:{"consumable":{consume_seconds:10000},"food":{"nutrition":0.0f,"saturation":0.0f,"can_always_eat":true},"custom_name":{"text":"Extended Arms","color":"#ff9d5c","italic":false},"max_stack_size":1}},CustomName:{"text":"Extended Arms","color":"#ff9d5c","italic":false},CustomNameVisible:1b}
execute at @s if score random_pink_item drop_item matches 10..11 run summon item ~ ~-1 ~ {Tags:[pink_drop_item],NoGravity:1b,Item:{id:"cake",components:{"consumable":{consume_seconds:10000},"food":{"nutrition":0.0f,"saturation":0.0f,"can_always_eat":true},"custom_name":{"text":"Heal Pool","color":"#fc9cf7","italic":false},"max_stack_size":1}},CustomName:{"text":"Heal Pool","color":"#fc9cf7","italic":false},CustomNameVisible:1b}
