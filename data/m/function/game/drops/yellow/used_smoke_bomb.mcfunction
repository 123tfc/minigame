...
execute if entity @s[nbt={Inventory:[{Slot: -106b, id: "minecraft:heavy_core", components:{"minecraft:food":{nutrition:0,saturation:0.0f}}}]}] unless entity @s[nbt={SelectedItem:{id:"minecraft:heavy_core",components:{"minecraft:food":{nutrition:0,saturation:0.0f}}}}] run item replace entity @s weapon.offhand with air
