...
execute at @s if score random_blue_item drop_item matches 3 run summon minecraft:zoglin ~ ~ ~ {Tags:[grenade_mob],attributes:[{base:0.9d,id:"minecraft:knockback_resistance"}]}
...
execute at @s if score random_blue_item drop_item matches 5 run summon minecraft:vindicator ~ ~ ~ {equipment:{head:{id:"minecraft:spawner",count:1},mainhand:{id:"minecraft:iron_axe",count:1,components:{"minecraft:enchantments":{"knockback":5}}}},Tags:[grenade_mob]}
