...
execute as @a[tag=!victory,tag=alive,gamemode=spectator] if score @s respawncooldown matches 1 unless score @s health matches 2 run tellraw @a [{"selector":"@s"},{"text":" fell into void","color":"white"}]
execute as @a[tag=!victory,tag=alive,gamemode=spectator] if score @s respawncooldown matches 1 if score @s health matches 2 run tellraw @a [{"selector":"@s"},{"text":" fell into void","color":"white"},{"text":" FINAL KILL!","bold":true,"color":"red"}]
