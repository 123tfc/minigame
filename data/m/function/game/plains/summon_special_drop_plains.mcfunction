...
#yellow
summon minecraft:text_display -162.5 132.0 -790.5 {Tags:[yellow_drop_td,special_drop],text:[{text:"\n Offensive Drop ",italic:true,bold:true,color:"#FFFF44"},{text:"\n||||||||||\n",italic:true,bold:true,color:"#FF0000"}],billboard:"vertical"}
...
summon minecraft:text_display -186.5 125.0 -821.5 {Tags:[blue_drop_td,special_drop],text:[{text:"\n Chaotic Drop ",italic:true,bold:true,color:"#AAAAFF"},{text:"\n||||||||||\n",italic:true,bold:true,color:"#FF0000"}],billboard:"vertical"}
