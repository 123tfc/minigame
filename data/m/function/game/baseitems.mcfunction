...
# Nether
execute if score @e[limit=1,tag=dummy] MapSwitch matches 3 run give @s stick[minecraft:max_stack_size=1,enchantments={"knockback":15},custom_name={"text":"Knockback Stick","color":"light_purple","italic":false}]
execute if score @e[limit=1,tag=dummy] MapSwitch matches 3 run give @s bow[minecraft:enchantment_glint_override=false,unbreakable={},enchantments={"punch":10},custom_name={"text":"Knockback Bow","color":"light_purple","italic":false}]
execute if score @e[limit=1,tag=dummy] MapSwitch matches 3 run give @s arrow 5