...
execute as @a[gamemode=!spectator,tag=sneaking,tag=!glowup] run effect give @s minecraft:glowing infinite 0 true
execute as @a[gamemode=!spectator,tag=!sneaking,tag=!glowup] run effect clear @s minecraft:glowing
